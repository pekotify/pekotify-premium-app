...
export default function DetailSong() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (isEdit) {
            audioPath = await axios.put('http://localhost:3001/songs/file/' + id, data, config
            ).then((res) => {
                console.log(res);
                return res.data;
            }).catch((err) => {
            ...
            audioPath = await axios.post('http://localhost:3001/songs/file', data, config
            ).then((res) => {
                console.log(res);
                return res.data;
            }).catch((err) => {
        ...
        if (isEdit) {
            response = await fetch('http://localhost:3001/songs/' + localStorage.getItem('songId'), {
                method: 'PUT',
                headers: {
